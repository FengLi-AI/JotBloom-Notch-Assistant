...
, origin_kind TEXT NOT NULL DEFAULT 'manual', source_clipboard_id INTEGER REFERENCES clipboard_items(id) ON DELETE SET NULL, source_application_name TEXT, source_bundle_identifier TEXT);
