...
VIAddVersionKey "FileVersion" "1.0.4 测试版"
VIAddVersionKey "ProductVersion" "1.0.4 测试版"
...
Section "萌生客户端（必选）" Main
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\JotBloom" "DisplayVersion" "1.0.4 测试版"
